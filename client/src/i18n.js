...
const TRANSLATIONS = {
  en: {
    ...
    'controls.shootShort': 'Press to shoot',
    ...
    'controls.move': 'Move',
    'controls.jump': 'Jump',
    'controls.shoot': 'Press to shoot the bow',
  ...
  es: {
    ...
    'controls.shootShort': 'Pulsa para disparar',
    ...
    'controls.shoot': 'Pulsa para disparar el arco',
